...
export const projects = [
    {
      ...
      description: "This project include my portfolio website. The site has been create with ReactJS. \n For Styles I wanted to use the Material UI",
    ...
    },
    {
      ...
      description: "In this project I sis an analysis of Cloud Gaming. In particular I assumed a fake Cloud Gaming Company performed and calculated the KPI about it",
      technology: [
    ...
    },
    {
      ...
      shortDescription:
        "Mobile application realized in Flutter.",
      description: "",
      technology: [
    ...
    },
    {
      ...
      description: "During my research collaboration with University of Milan I created a website for ISLab Laboratory.",
      technology: [
        { img: "/images/skills/react.png", name: "ReactJS" },
        { img: "/images/skills/mongo.png", name: "MongoDB" },
        { img: "/images/skills/python.png", name: "Python" },
    ...
    },
    {
      ...
      description: "During my second research collaboration with University of Milan I created a private platform for Philology Department.",
